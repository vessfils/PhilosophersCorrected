...
/*   Updated: 2022/05/05 11:28:39 by vess             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philo
{
	...
	unsigned int	nb_eat;	// number of dinners (each time the philosopher eats 
	nb_eat++)
}					t_philo;
*/
/*
...
/*
	...
	int				stop; // 0 if none philosopher is dead, 1 if a philosopher is dead,
	2 if all philosophers ate m_eat times
}			t_info;
*/
#endif